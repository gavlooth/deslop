...
| Rust | S1 plus evidenced graph facts/recipes | M3/M4 graph gold; M5 contracts; B2/B7 unreachable-literal slice | Other recipe families review-only; budget-abstained dogfood files grant no authority |
